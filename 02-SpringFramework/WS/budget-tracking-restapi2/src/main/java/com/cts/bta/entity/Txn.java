...
public class Txn implements Comparable<Txn> {
	...
	public Txn(Long txnId, @NotBlank(message = "This field is a mandate") String header,
			@NotNull(message = "This field is a mandate") @Min(value = 100, message = "A minimum of 100 is expected") @Max(value = 100000, message = "A maximum of 100000 is expected") Double amount,
			@PastOrPresent(message = "No future dates allowed") LocalDate txnDate,
			@NotNull(message = "This field is a mandate") TxnType type, AccountHolder holder) {
		super();
		this.txnId = txnId;
		this.header = header;
		this.amount = amount;
	...
	public int compareTo(Txn o) {
		return txnId==null? 1:txnId.compareTo(o.txnId);
	}
