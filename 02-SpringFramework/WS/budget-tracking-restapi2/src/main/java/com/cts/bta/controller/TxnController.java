...
public class TxnController {
	...
	@PostMapping
	public ResponseEntity<Txn> addTxn(@RequestBody @Valid Txn txn, BindingResult bindingResult) 
	...
	public ResponseEntity<Txn> saveTxn(@RequestBody @Valid Txn txn, BindingResult bindingResult, 
			String operation) throws BadTxnException {
